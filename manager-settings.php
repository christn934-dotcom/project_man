...
<div class="admin-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="manager-projects.php" class="nav-item"><span class="nav-icon">▣</span> My Projects</a>
            ...
            <a href="manager-settings.php" class="nav-item active"><span class="nav-icon">⚙</span> Settings</a>
